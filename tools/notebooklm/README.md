...
Query multiple notebooks simultaneously with the same question. Perfect for:
- **Project hierarchies**: Separate notebooks for sub-projects + overall project
- **Comparative analysis**: Compare information across different documentation sets
- **Comprehensive research**: Get perspectives from all your knowledge bases at once

Example use case: You have notebooks for "Backend API Docs", "Frontend Components", and "System Architecture". Ask all of them "What are the authentication requirements?" to get a complete picture.
...
| *"Ask all my notebooks about [topic]"* | Cross-notebook analysis across all notebooks |
...
### Example 3: Cross-Notebook Project Analysis

**You**: "Ask all my notebooks: What are the main risks and challenges? List 3 briefly."

**Claude's internal process:**
```
→ Loads NotebookLM skill
→ Finds all notebooks in library
→ Asks each notebook the same question
→ Aggregates responses
→ Synthesizes unified insights
```

**Result**: Comprehensive view of risks across all sub-projects, allowing you to identify common patterns and project-wide challenges.
